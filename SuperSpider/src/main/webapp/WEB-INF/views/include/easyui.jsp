...
<!-- easyui皮肤 -->
<link href="${ctx}/static/plugins/easyui/jquery-easyui-theme/<c:out value="${cookie.themeName.value}" default="bootstrap"/>/easyui.css" rel="stylesheet" type="text/css" />
...
<script src="${ctx}/static/plugins/easyui/jeasyui-extensions/jeasyui.extensions.superspider.js"></script>
...
<!-- 自定义的js -->
<script src="${ctx}/static/plugins/jquery/jquery.json-2.4.min.js"></script>
<script src="${ctx}/static/plugins/js/web/validate.js"></script>
<script src="${ctx}/static/plugins/js/web/HtmlUtil.js"></script>

<link rel="stylesheet" href="${ctx }/static/plugins/easyui/common/other.css"></link>

<!-- echart 文件  -->
<script src="${ctx}/static/plugins/echarts.js"></script>
<script>
...
$.ajaxSetup({
    ...
    complete:function(XMLHttpRequest,textStatus){
          ...
          if(sessionstatus=="timeout"){
               //跳转的登录页面
               window.location.replace('${ctx}/admin/login');
       		}	
    }
});
</script>
