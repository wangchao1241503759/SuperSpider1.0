...
<html>
<head>
<title>易瑞智能数据获取系统V3.1 配置管理</title>
...
function init(){
	$.ajax({
    	type: "POST",
        url: '${ctx}/taskMonitorController/initIndexMainPage',
        dataType : "html",
        success: function(d){
        	$("#base").html(d);
        }
...
<body>
    ...
    <div id="mainLayout" class="easyui-layout hidden" data-options="fit: true">
        <div id="northPanel" data-options="region: 'north', border: false" style="height: 80px; overflow: hidden;">
            <div id="topbar" class="top-bar">
                <div class="top-bar-left">
                    <h1 style="margin-left: 20px; margin-top: 10px;color: #fff"><span style="color: white;font-size: 25px;">SDI</span> <span style="color: white;margin-left:10px; font-size: 20px;">易瑞智能数据获取系统V3.1</span></h1>
                </div>
        ...
        <div data-options="region: 'east', title: '日历', iconCls: 'icon-standard-date', split: true,collapsed: true, minWidth: 160, maxWidth: 500" style="width: 220px;">
		 ...
		 <div data-options="region: 'south'" style="height: 20px; text-align: center;">
		 	 © 2016 北京英富森软件股份有限公司 版权所有
        </div>
    </div>
...
/* $(function () {
	$("#container").panel({
			onResize: function () {
				$("#container").attr("style","style='min-width:700px;height:400px;overflow: hidden;'");
			}
	});
}); */
$.ajax({
