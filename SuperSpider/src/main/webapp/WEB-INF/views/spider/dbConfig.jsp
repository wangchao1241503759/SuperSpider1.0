...
<%-- 			<jsp:include page="taskInfo.jsp" flush="false"/> --%>
		</div>
		
		<div id="source" class="easyui-panel" title="数据源设置" style="height: 300px;border:none" data-options="collapsible:true"s>
			<script>
				$(function() {
					panelcollapse('#source', false);
				});
			</script>
			<iframe src="${ctx}/spider/config/db/source" frameborder="0" scrolling="yes" height="100%" width="100%"></iframe>
		</div>
		<div id="target" class="easyui-panel" title="数据输出设置" style="height: 170px;border:none" data-options="collapsible:true">
			...
			<iframe src="${ctx}/spider/config/taskoutput" frameborder="0" scrolling="yes" width="100%" height="100%"></iframe>
		</div>
		<div id="regex" class="easyui-panel" title="采集规则设置"	style="height: 420px; border:none" data-options="collapsible:true">
			...
			<iframe src="${ctx}/spider/config/db/regex" frameborder="0"	scrolling="yes" height="100%" width="100%"></iframe>
		</div>
	</div>
	<div id="dlg"></div>
	<script>
		...
		$(function() {
			$("#mainlayout").panel({
				onResize: function () {
					...
					$("#regexTabs").panel('resize',{width:w});
