...
<body style="font-family: '微软雅黑'" onload="loadcompleted()">
	...
	<div id="mainlayout" class="easyui-panel" style="overflow: auto;border:none" data-options="fit:true">
		...
		<div id="source" class="easyui-panel" title="数据源设置" style="height: 260px; border:none" data-options="collapsible:true"s>
			<script>
				$(function() {
					panelcollapse('#source', false);
				});
			</script>
			<iframe src="${ctx}/spider/config/ftp/source" frameborder="0" scrolling="yes" height="100%" width="100%"></iframe>
		</div>
