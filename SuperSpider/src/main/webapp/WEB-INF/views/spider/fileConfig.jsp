...
<body style="font-family: '微软雅黑'" onload="loadcompleted()">
	...
	<div id="mainlayout" class="easyui-panel" style="overflow: auto;border:none" data-options="fit:true">
		...
		<div id="source" class="easyui-panel" title="数据源设置" style="height: 150px; border:none" data-options="collapsible:true"s>
			<script>
				$(function() {
					panelcollapse('#source', false);
				});
			</script>
			<iframe src="${ctx}/spider/config/file/source" frameborder="0" scrolling="yes" height="100%" width="100%"></iframe>
		</div>
		...
		<div id="regex" class="easyui-panel" title="采集规则设置" style="height: 370px; border:none" data-options="collapsible:true">
			<script>
				$(function() {
					panelcollapse('#regex', false);
				});
			</script>
			<iframe src="${ctx}/spider/config/file/regex" frameborder="0" scrolling="yes" height="100%" width="100%"></iframe>
		</div>
	</div>
	<div id="dlg"></div>
	<script>
