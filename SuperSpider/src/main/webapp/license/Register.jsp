...
<%
String mcode = null;
mcode = CommonTools.getMachinecode();
%>
<html>
  <head>
    ...
    <script language="JavaScript">
	  ...
	  function tj_onclick(){
	    ...
	    document.form1.action = "RegisterSuccess.jsp";
		  ...
		  <tr>
		    <td align="left" valign="top">
			    <table width="264" border="0" cellpadding="0" cellspacing="0" class="table_01">
			      <tr>
			        <td height="24" align="left"><img src="images/organization.gif" width="138" height="16" /></td>
			      </tr>
			      <tr>
			        <td height="34" align="left" valign="top"><input type="text" name="orgname" class="form_01" value="" /></td>
			      </tr>
			      <tr>
			        <td height="24" align="left"><img src="images/createstaff.gif" width="133" height="16" /></td>
			      </tr>
			      <tr>
			        <td height="34" align="left" valign="top"><input type="text" name="username" class="form_01" value="" /></td>
			      </tr>
			      <tr>
			        <td height="24" align="left"><img src="images/machinecode.gif" width="133" height="16" /></td>
			      </tr>
			      <tr>
			        <td height="84" align="left" valign="top"><textarea name="machinecode" class="form_03" readonly="readonly"><%=mcode%></textarea></td>
			      </tr>
			      <tr>
			        <td height="24" align="left"><img src="images/license.gif" width="102" height="16" /></td>
			      </tr>
			      <tr>
			        <td height="80" align="left" valign="top"><textarea name="serialcode" class="form_04" /></textarea></td>
			      </tr>
			      <tr>
			        <td height="24" align="left"><img src="images/notes.gif" width="102" height="16" /></td>
			      </tr>
			      <tr>
			      ...
			      <tr>
			        <td height="40" align="center" valign="bottom">
				        <table width="80%" border="0" cellspacing="0" cellpadding="0">
				          <tr>
				            <td align="center"><input type="image" src="images/tj.gif" width="107" height="27" onClick="tj_onclick()"></td>
				            <td align="center"><input type="image" src="images/cz.gif" width="107" height="27" onClick="cz_onclick()"></td>
				          </tr>
				        </table>
				    </td>
			      </tr>
