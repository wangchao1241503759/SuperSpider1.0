package cn.com.infcn.startup.jetty;
 ...
 * 创建Jetty Server的工厂类.
 * 
 * @author WChao 2015年8月15日更改
 */
public class JettyFactory {

	public static Logger logger = LoggerFactory.getLogger(JettyFactory.class);

	private static String DEFAULT_WEBAPP_PATH = "src/main/webapp";
	private static final String WINDOWS_WEBDEFAULT_PATH = "src/main/java/cn/com/infcn/startup/jetty/webdefault-windows.xml";
	...
	public static Server createServerInSource(int port, String contextPath) {
		...
		File webdir = new File(DEFAULT_WEBAPP_PATH);
		...
		if (new File(WINDOWS_WEBDEFAULT_PATH).exists()) {
			webContext.setDefaultsDescriptor(WINDOWS_WEBDEFAULT_PATH);
		} else {
			logger.warn(WINDOWS_WEBDEFAULT_PATH + " not found!");
		}
