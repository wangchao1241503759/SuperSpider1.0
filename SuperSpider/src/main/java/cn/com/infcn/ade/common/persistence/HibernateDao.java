package cn.com.infcn.ade.common.persistence;
...
import cn.com.infcn.ade.common.persistence.PropertyFilter.MatchType;
import cn.com.infcn.ade.common.utils.Reflections;
...
public class HibernateDao<T, PK extends Serializable> extends SimpleHibernateDao<T, PK> {
	 ...
	 * @return
	 */
	public Integer executeHql(final String hql,Object... values) {
		return this.batchExecute(hql, values);
	}
	/**
	 * 执行HQL语句进行数据操作;
	 * @param hql
	 ...
	 * @return
	 */
	public Integer executeHql(final String hql, final Map<String, ?> values) {
		return this.batchExecute(hql, values);
	}
	/**
	 * 执行SQL语句进行数据操作;
	 ...
	 * @return
	 */
    public Integer executeSql(final String sql, final Map<String, ?> values) {
