 ...
 * 
 */
package cn.com.infcn.superspider.io.output.adapter.mysql;
 ...
 */
public class MysqlOutputAdapter extends OutputAdapter{

	Logger logger = Logger.getLogger(jdbcOutputAdapter.class);
	private BasicDao basicDao = null;
	
	public MysqlOutputAdapter(){}
	public MysqlOutputAdapter(JSONObject obj, Site site) throws Throwable {
		this.site = site;
		init(obj);
	}
	public MysqlOutputAdapter(JSONObject obj, Site site ,SpiderListener listener) throws Throwable {
		this(obj,site);
	...
	public void CreateTable(JSONObject tableStruct)
	{
		...
		try {
			...
			{
				String deleteSql = "DROP TABLE IF EXISTS `"+dbModel.getTablename()+"`";
