...
public class Sys {
	...
	public static void main(String[] args) {
		...
		try {
			Properties properties = Sys.loadPropertiesResource("com/justme/superspider/plugin/db/adapter/config.properties");
			System.out.println(properties);
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		InputStream is = classloader.getResourceAsStream("com/justme/superspider/plugin/db/adapter/config.properties");
